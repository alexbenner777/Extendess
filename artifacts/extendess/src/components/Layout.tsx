  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground font-sans relative selection:bg-primary selection:text-primary-foreground">
      ...
      <div className="fixed bottom-5 right-5 z-50 pointer-events-auto">
        <Link
          href="/contacts"
          className="flex items-center justify-center bg-black text-white px-6 py-3.5 text-[10px] font-bold uppercase tracking-widest shadow-xl transition-all duration-300 hover:scale-105 hover:bg-black/80 border border-white/10"
        >
          Записаться
        </Link>
      </div>
