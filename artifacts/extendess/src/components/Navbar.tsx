    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <Link
            href="/contacts"
            className="px-6 py-3 bg-primary text-primary-foreground text-xs font-semibold uppercase tracking-widest rounded-full hover:bg-primary/90 transition-colors"
          >
            Записаться
          </Link>
        </div>
          ...
          >
            ...
            >
              <Link
                href="/contacts"
                onClick={() => setIsMobileMenuOpen(false)}
                className="px-10 py-4 bg-primary text-primary-foreground text-xs font-semibold uppercase tracking-widest w-64 text-center block rounded-full"
              >
                Записаться
              </Link>
            </motion.div>
