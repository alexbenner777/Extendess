  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="relative flex items-center justify-center" style={{ width: 260, height: 380 }}>
            <svg
            ...
            <div className="relative flex flex-col items-center gap-8 px-8">
              ...
              >
                ...
                <span className="text-[8px] uppercase tracking-[0.5em] text-white/40 font-light">
                  Загрузка
                </span>
              </motion.div>
            </div>
