          ...
          <div className="md:col-span-7 md:pt-8">
            <FadeIn delay={0.3}>
              <div className="space-y-5 text-base md:text-lg font-light text-black/60 leading-relaxed">
                ...
                <p>Для нас красота — это не отдельная процедура и не следование трендам. Это результат профессионального подхода, современных технологий и внимания к клиенту.</p>
                <p>Сейчас бренд проходит этап масштабного обновления, и впереди ещё много нового. Но главное остаётся неизменным — люди, экспертиза и стандарты, которым доверяют наши гости.</p>
              </div>
            </FadeIn>
          </div>
        </div>
