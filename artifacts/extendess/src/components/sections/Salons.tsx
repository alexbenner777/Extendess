...
export function Salons() {
  ...
  return (
    <section id="salons" className="bg-[#F1EBE3]">
      ...
      {/* Section label */}
      <div className="px-6 md:px-16 pt-28 md:pt-36">
      ...
      <div className="flex flex-col md:flex-row items-center pt-6 md:pt-8" style={{ minHeight: 500 }}>
        ...
        >
          ...
          <div className="absolute bottom-6 right-6 z-10 flex gap-2">
            <button
              onClick={() => go(active - 1)}
              className="w-9 h-9 flex items-center justify-center border border-white/30 text-white/60 hover:border-white hover:text-white transition-all duration-200 backdrop-blur-sm bg-black/10 rounded"
